// one easy approach is to sort the word or count the frequency and use it as 
// key of map and store all anagrams in map

// other approach is using trie, push the index of all anagrams in the word end node 
